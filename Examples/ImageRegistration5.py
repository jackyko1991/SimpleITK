...
#R.SetOptimizerAsRegularStepGradientDescent(1, .001, 400, relaxationFactor=0.6 )
R.SetOptimizerAsAmoeba(5, .001, .001, 400 )
R.SetOptimizerScales([1000.0, 10.0,.1,.1])
R.SetTransform(sitk.Transform(fixed.GetDimension(), sitk.sitkSimilarity))
...
if ( not "SITK_NOSHOW" in os.environ ):
    ...
    sitk.Show( cimg, "ImageRegistration5 Composition" )
